...
Avant de commencer, assurez-vous d'avoir installé soit Wamp soit Xampp sur votre système. Vous pouvez télécharger Wamp depuis [ici](https://wampserver.aviatechno.net/) ou Xampp depuis [ici](https://www.apachefriends.org/fr/index.html).
