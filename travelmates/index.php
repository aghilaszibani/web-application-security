...
?>
  ...
  <div class="main">
    ...
    <div class="section section-dark text-center" id="jointravelgo">
      <div class="joinwrapper ml-auto mr-auto" style="width: 90%;">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
           <img class="img-responsive" data-aos="fade-up" data-aos-delay="50" id="joinimg" src="https://snaphappyspoonie.com/wp-content/uploads/2021/04/Travelling-alone-for-the-first-time-Featured-Image-780x650.jpg" alt="Card image cap" style="width: 100%;height: 400px;border-radius: 2%;">
    ...
    <!--<div class="section pt-o" id="carousel">
        ...
        <h2 class="title text-center">Destinations</h2>
          <div class="col-md-8 ml-auto mr-auto">
          <div class="imgtriggers text-center">
            <button class="btn btn-secondary imgtrig" onclick="loadImage('algeria.jpg', '1.jpg')">Alger</button>
            <button class="btn btn-secondary imgtrig" onclick="loadImage('paris.jpg', '2.jpg')">Paris</button>
            <button class="btn btn-secondary imgtrig" onclick="loadImage('newyork.jpg', '3.jpg')">New York</button>
            <button class="btn btn-secondary imgtrig" id="btn">New York</button>

    
          </div>
          <div class="image-container" id="imageContainer" style="display: flex; justify-content: center; align-items: center;  text-align: center; margin-top: 20px;"></div>
          <style type="text/css">
            .imgtrig{
             margin: 10px;
            }
