...
$pseudo = $_SESSION['user'];
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputText4" placeholder="Pseudo" value="<?php echo $pseudo?>">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="file" class="" id="inputFile4" placeholder="" name="img_profil" accept="">


      <input type="hidden" name="csrf_token" id="csrf" value="<?php echo $_SESSION['csrf_token']; ?>">
...
<?php 
        ...
        if (move_uploaded_file($_FILES['img_profil']['tmp_name'], $target)) {
          ...
          $querymo = "UPDATE utilisateur SET nom='$nom', prenom='$prenom', email='$email',  mot_de_passe='$hashedPassword', num_tel='$num_tel', date_naissance='$date_naissance', sexe='$sexe', pays='$pays', ville='$ville', zip='$zip', adress='$adress', img_profil = '$imgprofil' WHERE pseudo= '$pseudoverif' ";
        ...
        if(!$querymod){
          ...
          if ($mot_de_passe == $mot_de_passe2) {
          $querymo = "UPDATE utilisateur SET nom='$nom', prenom='$prenom', email='$email',  mot_de_passe='$hashedPassword', num_tel='$num_tel', date_naissance='$date_naissance', sexe='$sexe', pays='$pays', ville='$ville', zip='$zip', adress='$adress' WHERE pseudo= '$pseudoverif' ";
        $querymod = mysqli_query($con,$querymo);
        if(!$querymod){
                    die("QUERY FAILED".mysqli_error($con));
                    }
