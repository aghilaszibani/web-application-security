...
<?php $pseudo = $_SESSION['user'];
  ...
  <div class="section profile-content">
    ...
    <?php $queryfollow="SELECT * FROM voyage WHERE id_utilisateur=$id_session";
        $queryresultf = mysqli_query($con,$queryfollow);
                ...
                <li>
                  <div class="row">
                    <div class="col-lg-7 col-md-4 col-4  ml-auto mr-auto">
                      <a href="voyage.php?id_voyage=<?php echo $id_voyage ?>"><h6><?php echo $titre_voyage ?>
                        <br/>
                    ...
                    <div class="col-lg-3 col-md-4 col-4  ml-auto mr-auto">
                      <div class="form-check">
                        <label class="form-check-label">
                          <a href="deletevoyage.php?id=<?php echo $id_voyage ?>" class="btn btn-warning">Supprimer</a>
                        </label>
                      </div>
                    </div>
                  </div>
